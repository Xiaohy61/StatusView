...
public class StatusFrameLayout extends FrameLayout implements StatusView {
    ...
    public StatusFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StatusFrameLayout, defStyleAttr, 0);
        contentViewResId = typedArray.getResourceId(R.styleable.StatusFrameLayout_fContentView, defValue);
        loadingViewResId = typedArray.getResourceId(R.styleable.StatusFrameLayout_fLoadingView, defValue);
        emptyViewResId = typedArray.getResourceId(R.styleable.StatusFrameLayout_fEmptyView, defValue);
        errorViewResId = typedArray.getResourceId(R.styleable.StatusFrameLayout_fErrorView, defValue);
        noNetworkViewResId = typedArray.getResourceId(R.styleable.StatusFrameLayout_fNoNetworkView, defValue);
        extendViewResId = typedArray.getResourceId(R.styleable.StatusFrameLayout_fExtendView, defValue);
        typedArray.recycle();
    }
