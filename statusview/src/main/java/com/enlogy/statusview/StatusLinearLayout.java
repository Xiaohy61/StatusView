...
public class StatusLinearLayout extends LinearLayout implements StatusView {
    ...
    public StatusLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StatusLinearLayout, defStyleAttr, 0);
        contentViewResId = typedArray.getResourceId(R.styleable.StatusLinearLayout_lContentView, defValue);
        loadingViewResId = typedArray.getResourceId(R.styleable.StatusLinearLayout_lLoadingView, defValue);
        emptyViewResId = typedArray.getResourceId(R.styleable.StatusLinearLayout_lEmptyView, defValue);
        errorViewResId = typedArray.getResourceId(R.styleable.StatusLinearLayout_lErrorView, defValue);
        noNetworkViewResId = typedArray.getResourceId(R.styleable.StatusLinearLayout_lNoNetworkView, defValue);
        extendViewResId = typedArray.getResourceId(R.styleable.StatusLinearLayout_lExtendView, defValue);
        typedArray.recycle();
    }
